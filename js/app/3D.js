...
gltfLoader.load("/models/treeline.glb", function (gltf) {
  ...
  gltfLoader.load("/models/tree.glb", function (gltf) {
    ...
    const color = new THREE.Color();
    // Palette uses colors: #397a4c, #bedb92, #569358
    const treePalette = [0x397a4c, 0xbedb92, 0x569358];
...
var mixer3;
var action3;
gltfLoader.load("/models/poboisvert.glb", function (gltf) {
  var modelPO = gltf.scene;

  //Playing Animation
  mixer3 = new THREE.AnimationMixer(modelPO);
  ...
  scene.add(modelPO);
  modelPO.scale.set(1, 1, 1);
  modelPO.position.set(-3.5, 0, 10);
  modelPO.rotation.y = 0;
});
